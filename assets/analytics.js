...
*/
  ...
  var bd = function (a) {
    ...
    ge = function (a, b, c) {
      1 <= 100 * Math.random() || G("?") || ((a = ["t=error", "_e=" + a, "_v=j96", "sr=1"]), b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua));
    };
  var qc = function () {
  ...
  var p = /^(GTM|OPT)-[A-Z0-9]+$/,
    ...
    Ke = function (a, b, c, d) {
      ...
      var g = { id: b, type: e, B: c.dataLayer || "dataLayer", G: !1 },
        ca = void 0;
      a.get("&gtm") == b && (g.G = !0);
      1 === e ? ((g.ia = !!a.get("anonymizeIp")), (g.sync = d), (b = String(a.get("name"))), "t0" != b && (g.target = b), G(String(a.get("trackingId"))) || ((g.clientId = String(a.get(Q))), (g.ka = Number(a.get(n))), (c = c.palindrome ? r : q), (c = (c = M.cookie.replace(/^|(; +)/g, ";").match(c)) ? c.sort().join("").substring(1) : void 0), (g.la = c), (g.qa = E(P(a, kb), "gclid")))) : 2 === e && ((g.context = "c"), (ca = { allow_google_signals: a.get(Ud), allow_ad_personalization_signals: a.get(xe) }));
      He(g, ca);
      return t(g);
    };
  var H = {},
